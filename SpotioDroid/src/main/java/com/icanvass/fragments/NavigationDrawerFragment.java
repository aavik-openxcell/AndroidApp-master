 ...
 */
public class NavigationDrawerFragment extends Fragment implements RefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDrawerListView.setAdapter(new DrawerAdapter(
                ...
                new String[]{
                        ...
                        getString(R.string.title_section_satellite),
                        getString(R.string.title_section_user),
                        getString(R.string.title_section_status),
                        getString(R.string.title_section_questions),
                        getString(R.string.title_section_delete),
                        getString(R.string.title_section_support),
    ...
    private void selectItem(int position) {
        ...
        if (mCallbacks != null) {
            mCallbacks.onNavigationDrawerItemSelected(position, (String)mDrawerListView.getAdapter().getItem(position));
        }
        Log.i("Navigator", "C" + position);
    }
...
//        }
    ...
    public class DrawerAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ImageView ic_refresh = (ImageView) convertView.findViewById(R.id.ic_refresh);
            if (title.equals(getString(R.string.title_section_refresh))) {
                ic_refresh.setVisibility(View.VISIBLE);
                if (isRefreshing) {
                    Animation rotation = AnimationUtils.loadAnimation(getActivity(), R.anim.rotation_refresh);
                    rotation.setRepeatCount(Animation.INFINITE);
                    ic_refresh.startAnimation(rotation);
                } else {
                    ic_refresh.clearAnimation();
                }
            } else {
            ...
            if(title.equals(getString(R.string.title_section_satellite))) {
                ...
                toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        if(isChecked) {
                            editor.putString("SATELLITE","on");
                        }else{
                            editor.remove("SATELLITE");
                        }
                        editor.apply();
                        Intent intent = new Intent();
                        intent.setAction("com.spotio.Satellite");
        ...
        public boolean isEnabled(int position) {
            return getItem(position).equals("")
                    || !getItem(position).equals(getString(R.string.title_section_satellite));
        }
    }
}
