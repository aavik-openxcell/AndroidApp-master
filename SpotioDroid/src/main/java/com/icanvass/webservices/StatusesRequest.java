...
public class StatusesRequest extends SpiceRequest<JSONObject> {

    String mEmail;
    String mPassword;
    String mCompany;

    public StatusesRequest(Context ctx) {
    ...
    public JSONObject loadDataFromNetwork() throws Exception {
        ...
        Uri.Builder uriBuilder = Uri.parse(
                "http://services.spotio.com:888/PinService.svc/PinStatus?$format=json").buildUpon();
